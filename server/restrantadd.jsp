...
try{
	...
	if (rs.getString("RestrantImage") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `restrant` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = "'" + tmpfld + "'";
			...
			strsql = "SELECT * FROM `restrant` WHERE `RestrantName` = '" + srchfld +"'";
			...
			if (rschk.next()) {
				out.print("Duplicate key for RestrantName, value = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Add to TABLE: restrant<br><br><a href="restrantlist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="restrantadd.jsp" method="post">
<p>
