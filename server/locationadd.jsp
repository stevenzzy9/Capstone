...
try{
	...
	x_locationtype = String.valueOf(rs.getLong("locationtype"));
		...
		// Open record
		String strsql = "SELECT * FROM `location` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = tmpfld;
			...
			strsql = "SELECT * FROM `location` WHERE `userid` = " + srchfld;
			...
			if (rschk.next()) {
				out.print("Duplicate key for userid, value = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Add to TABLE: location<br><br><a href="locationlist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="locationadd.jsp" method="post">
<p>
