...
try{
	...
	if (rs.getString("Location") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `movie` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = "'" + tmpfld + "'";
			...
			strsql = "SELECT * FROM `movie` WHERE `MovieName` = '" + srchfld +"'";
			...
			if (rschk.next()) {
				out.print("Duplicate key for MovieName, value = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Add to TABLE: movie<br><br><a href="movielist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="movieadd.jsp" method="post">
<p>
