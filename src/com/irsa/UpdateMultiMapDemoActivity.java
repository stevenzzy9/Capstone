...
public class UpdateMultiMapDemoActivity extends FragmentActivity implements
		...
		protected String doInBackground(Void... args) {
			...
			try {
				...
				result = pmHttp.get(PubContant.WEBSERVERUSER
						...
						+ PubContant.CurrentUser.getUsername() + "&userpassword=" + PubContant.CurrentUser.getUsername());
